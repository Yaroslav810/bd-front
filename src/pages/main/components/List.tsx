import { Avatar, Card, CardActionArea, CardContent, CardHeader, ImageListItem } from '@mui/material'
  ...
  >
    <CardActionArea>
      <CardContent className={styles.content}>
        ...
        {props.event.image && <ImageListItem sx={{ width: 370 }} className={styles.image}><img src={getImage(props.event.image)} alt="image" /></ImageListItem>}
      </CardContent>
      <CardHeader
        avatar={
